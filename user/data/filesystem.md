...
You can check how much storage you are using by running the `du` command in a terminal, but since many hubs link a ``~/shared`` folder we exclude that from our file size tally:
