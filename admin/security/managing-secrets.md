...
1. In the *{icon}`octicon:gear` Settings* menu, click on *{icon}`octicon:key-asterisk-16` Secrets and Tokens > Actions* in the left-side menu. 
...
1. Click the *{icon}`octicon:gear` Admin* button.
