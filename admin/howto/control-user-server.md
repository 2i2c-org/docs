...
```{note}
A crude way to ensure that a server isn't stopped for inactivity is can be read
about [here](https://github.com/jupyterhub/jupyterhub-idle-culler/issues/55#issuecomment-1413510651).
```
