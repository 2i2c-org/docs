...
All of the configuration for a 2i2c JupyterHub exists at the {ref}`infrastructure repository<infra:index>. This is a "meta" repository that centralizes configuration and deployment of many 2i2c JupyterHubs.
