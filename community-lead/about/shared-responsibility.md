...
2. **Provide support to community leaders**. Follow our service [support process](xref:tc#support:process) for community leaders.
...
Acts as a bridge between the communities we work with and our [Site Reliability Engineers](#role:site-reliability-engineer). Facilitates information transfer, signal-boosts community needs and requests, and guides communities in utilizing the infrastructure more effectively.

See the [Support Team Documentation](xref:tc#support:process) for more information.
