...
A matrix of our services and their prices are at the link below.
...
There are two types of costs associated with our service: **human costs** and **cloud costs**.
...
- **Cloud costs** cover the cost we pay a cloud provider for the infrastructure that powers your service.
  ...
  See [](costs:cloud) for more information.
